...
while [[ $# -gt 0 ]]; do
    case "$1" in
        ...
        --help)
            ...
            echo "  --hub             Install as hub node (elected relay hub-node)"
...
# Copy generic receiver for framework integrations
...
echo "🏗️  Role:            $( $IS_HUB && echo "HUB (relay hub-node)" || echo "Peer" )"
echo ""
echo "Add to ~/.bashrc:"
echo "─────────────────────────────────"
...
echo ""
echo "📚 Docs: https://github.com/justfeltlikerunning/agent-mesh"
